...
INSERT INTO `rating` VALUES (1,5,'Rath Ltd'),(2,4,'Kerluke-Herman'),(3,3,'Berge Inc'),(4,5,'Hamill, Prohaska and Lehner'),(5,1,'Ratke LLC'),(6,2,'Fisher-Rempel'),(7,3,'Ryan, Jaskolski and Schinner'),(8,5,'Kub, Borer and Ward'),(9,4,'O\'Conner-Mraz'),(10,2,'Mayert LLC'),(11,3,'Grady, Kreiger and Frami'),(12,1,'Abbott-Schmitt'),(13,2,'Ankunding Group'),(14,5,'Weber, Lehner and Mueller'),(15,5,'Connelly, Wolf and Murazik'),(16,2,'Abernathy, Lehner and Zulauf'),(17,3,'Heathcote, Kovacek and Cummerata'),(18,4,'Hauck, Rodriguez and Cremin'),(19,1,'Hermiston-Purdy'),(20,5,'Smitham-Haley'),(21,4,'Rath Ltd'),(22,5,'Kerluke-Herman'),(23,2,'Berge Inc'),(24,3,'Hamill, Prohaska and Lehner'),(25,5,'Ratke LLC'),(26,4,'Fisher-Rempel'),(27,3,'Ryan, Jaskolski and Schinner'),(28,2,'Kub, Borer and Ward'),(29,5,'O\'Conner-Mraz'),(30,5,'Mayert LLC'),(31,2,'Grady, Kreiger and Frami'),(32,3,'Abbott-Schmitt'),(33,4,'Ankunding Group'),(34,1,'Weber, Lehner and Mueller'),(35,5,'Connelly, Wolf and Murazik'),(36,4,'Abernathy, Lehner and Zulauf'),(37,3,'Heathcote, Kovacek and Cummerata'),(38,5,'Hauck, Rodriguez and Cremin'),(39,2,'Hermiston-Purdy'),(40,4,'Smitham-Haley');
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `AverageRatings` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `AverageRatings`()
BEGIN

SELECT restaurant_name, ROUND(AVG(CAST(rating AS decimal)), 2) AS Average_Rating
FROM rating
...
-- Dump completed on 2021-04-28 14:36:36
